...
const DeanActivityHistory: React.FC = () => {
  ...
  const fetchSystemActivities = async () => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/api/auth/system-activities`, {
  ...
  return (
    ...
    >
      ...
      >
        <Box display="flex" alignItems="center" gap={2} mb={3} sx={{ flexWrap: { xs: "wrap", sm: "nowrap" }, width: "100%" }}>
          <Box
            sx={{
              p: 1.5,
              borderRadius: 2,
        ...
        <Grid container spacing={2} alignItems="center" sx={{ width: "100%" }}>
          ...
          <Grid item xs={6} sm={4} md={2} lg={2}>
            <FormControl fullWidth size="small">
              ...
              <Select value={selectedType} label="Activity Type" onChange={(e) => setSelectedType(e.target.value)}>
                <MenuItem value="">All</MenuItem>
      ...
      <TableContainer
        ...
        sx={{
          ...
          width: "100%",
          maxWidth: "100%",
          // <-- left padding added here (responsive)
          pl: { xs: 1, sm: 3, md: 4 },
          pr: 2,
        }}
      >
        <Box
          sx={{
            ...
            overflow: "auto",
            width: "100%",
            // ensure inner scrolling area respects the left padding as well
            pl: { xs: 0.5, sm: 2.5, md: 3.5 },
          }}
        >
                ...
                paginatedActivities.map((activity, index) => (
                  ...
                  >
                    ...
                    <TableCell sx={{ minWidth: 120 }}>
                      <Typography variant="body2">{activity.performedBy}</Typography>
                    </TableCell>
                    <TableCell sx={{ minWidth: 120 }}>
                      <Typography variant="body2" sx={{ fontWeight: 500 }}>
