...
const FaceRegistration: React.FC = () => {
  ...
  useEffect(() => {
    // First filter to only show instructors and program chair persons
    let filteredUsers = users.filter(user => 
      user.role === 'instructor' || user.role === 'programchairperson'
    );
        ...
        <Box sx={{ 
          ...
          <Box sx={{ 
            ...
            <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 'medium' }}>
              Loading staff from your college...
            </Typography>
    ...
    <DeanMain>
      <Box sx={{ 
              ...
              <Box sx={{ 
                ...
                <Box>
                  ...
                  <Typography variant="body1" color="text.secondary" sx={{ 
                    ...
                    Manage staff face recognition for attendance
                  </Typography>
                </Box>
              </Box>
        ...
        <Box sx={{ 
          ...
          <TextField
            fullWidth
              placeholder="Search staff by name, email, or course..."
            value={searchTerm}
        ...
        {filteredUsers.length === 0 && !loading && (
          <Fade in={true} timeout={500}>
            ...
            <Typography 
              ...
              >
                {searchTerm ? "Try adjusting your search terms or filters" : "No staff available in your college"}
          </Typography>
              {searchTerm && (
                <Button
                  variant="outlined"
