...
import {
  Dashboard, People, Videocam, Assessment, PendingActions, PersonAdd, AccessTime, Layers, History
...
const AdminMain: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { text: "Course & Block Management", icon: <Layers />, path: "/course-block-management/:id" },
    ...
    { text: "Activity History", icon: <History />, path: "/activity-history/:id" },
